...
if os.path.isfile('./stock_data/RAW/Indices.csv'):
    data = []
    ...
    for i in range(len(data)):
        temp = clear_dash(i, temp, data, 4, 0)
        temp = clear_dash(i, temp, data, 1, 1)
        temp = clear_dash(i, temp, data, 2, 8)
        temp = clear_dash(i, temp, data, 3, 9)
    ...
    with open('./stock_data/DATA/DATA_Indices.csv', 'w', newline='') as csvfile:
