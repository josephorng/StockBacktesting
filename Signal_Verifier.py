...
def score(temp_list, index, day):
    score_def = (temp_list[index + day - 1][0] + temp_list[index + day][0] + temp_list[index + day + 1][0] -
                 temp_list[index][0] * 3) / (3 * temp_list[index][0]) * 100
    return score_def


def score_next_day_CP(temp_list, index, day):
    score_def = (temp_list[index + day - 1][0] + temp_list[index + day][0] + temp_list[index + day + 1][0] -
                 temp_list[index + 1][0] * 3) / (3 * temp_list[index + 1][0]) * 100
    return score_def


def score_next_day_OP(temp_list, index, day):
    score_def = (temp_list[index + day - 1][0] + temp_list[index + day][0] + temp_list[index + day + 1][0] -
                 temp_list[index + 1][1] * 3) / (3 * temp_list[index + 1][1]) * 100
    return score_def
...
last_list = ['LastLow↥', 'Last2High↥', 'LastHigh↧', 'Last2low↧', 'LastNone']
name_list = ['None', 'Body+', 'Body2+', 'Body-', 'Body2-']
slope_list = ['slp↗', 'slp↘', 'slp↕']
stock_list = text2list('ALL.txt')
total_list = []
folder = './Comparison/Signal_verifier/'
...
for name in name_list:
    for last in last_list:
        for align_y in align_list:
            if align_y == '5↘20↘60':
                align_t_list = ['5↘20↘60', '20↘5↘60', '5↘60↘20']
            elif align_y == '5↘60↘20':
                align_t_list = ['5↘60↘20', '60↘5↘20', '5↘20↘60']
            elif align_y == '60↘5↘20':
                align_t_list = ['60↘5↘20', '5↘60↘20', '60↘20↘5']
            elif align_y == '60↘20↘5':
                align_t_list = ['60↘20↘5', '20↘60↘5', '60↘5↘20']
            elif align_y == '20↘60↘5':
                align_t_list = ['20↘60↘5', '60↘20↘5', '20↘5↘60']
            elif align_y == '20↘5↘60':
                align_t_list = ['20↘5↘60', '5↘20↘60', '20↘60↘5']
            for align_t in align_t_list:
                for slope in slope_list:
                    ...
                    total_score_30 = 0
                    total_score_60 = 0
                    total_score_NDCP_5 = 0
                    total_score_NDCP_10 = 0
                    total_score_NDCP_20 = 0
                    total_score_NDCP_30 = 0
                    total_score_NDOP_5 = 0
                    total_score_NDOP_10 = 0
                    total_score_NDOP_20 = 0
                    total_score_NDOP_30 = 0
                    write_up_list = []
                    write_down_list = []
                    write_all_list = []
                    ...
                    for stock in stock_list:
                        if os.path.isfile('./stock_data/DATA/DATA_' + stock + '.csv'):
                            ...
                            with open('./stock_data/DATA/DATA_' + stock + '.csv') as csvfile:
                                ...
                                for row in reader:
                                    temp.append(row)
                            for j in range(301, len(temp[:])-61):
                                if signal_type(name, last, slope, align_t, align_y, j, temp):
                                    ...
                                    score_60D = score(temp, j, 60)
                                    score_NDCP_5D = score_next_day_CP(temp, j, 5)
                                    score_NDCP_10D = score_next_day_CP(temp, j, 10)
                                    score_NDCP_20D = score_next_day_CP(temp, j, 20)
                                    score_NDCP_30D = score_next_day_CP(temp, j, 30)
                                    score_NDOP_5D = score_next_day_OP(temp, j, 5)
                                    score_NDOP_10D = score_next_day_OP(temp, j, 10)
                                    score_NDOP_20D = score_next_day_OP(temp, j, 20)
                                    score_NDOP_30D = score_next_day_OP(temp, j, 30)
                                    ...
                                    if score_5D < 61 and (score_10D+100) / (score_5D+100) < 259 / 161 \
                                        ...
                                        total_score_60 = total_score_60 + score_60D
                                        total_score_NDCP_5 = total_score_5 + score_NDCP_5D
                                        total_score_NDCP_10 = total_score_10 + score_NDCP_10D
                                        total_score_NDCP_20 = total_score_20 + score_NDCP_20D
                                        total_score_NDCP_30 = total_score_30 + score_NDCP_30D
                                        total_score_NDOP_5 = total_score_5 + score_NDOP_5D
                                        total_score_NDOP_10 = total_score_10 + score_NDOP_10D
                                        total_score_NDOP_20 = total_score_20 + score_NDOP_20D
                                        total_score_NDOP_30 = total_score_30 + score_NDOP_30D
                                        ...
                                        write_list = [stock, year, month, date, CP_td, Big_CP,
                                                      ...
                                                      score_NDCP_5D, score_NDCP_10D, score_NDCP_20D, score_NDCP_30D,
                                                      score_NDOP_5D, score_NDOP_10D, score_NDOP_20D, score_NDOP_30D]
                    ...
                    if total >= 40:
                        ...
                        print('60D_score = ' + str(total_score_60 / total))
                        print('5D_score_NDCP = ' + str(total_score_NDCP_5 / total))
                        print('10D_score_NDCP = ' + str(total_score_NDCP_10 / total))
                        print('20D_score_NDCP = ' + str(total_score_NDCP_20 / total))
                        print('30D_score_NDCP = ' + str(total_score_NDCP_30 / total))
                        print('5D_score_NDOP = ' + str(total_score_NDOP_5 / total))
                        print('10D_score_NDOP = ' + str(total_score_NDOP_10 / total))
                        print('20D_score_NDOP = ' + str(total_score_NDOP_20 / total))
                        print('30D_score_NDOP = ' + str(total_score_NDOP_30 / total) + '\n')
                        total_list.append([name, total, last, align_y, align_t, slope,
                                           total_score_5 / total, total_score_10 / total, total_score_20 / total, total_score_30 / total, total_score_60 / total,
                                           total_score_NDCP_5 / total, total_score_NDCP_10 / total, total_score_NDCP_20 / total, total_score_NDCP_30 / total,
                                           total_score_NDOP_5 / total, total_score_NDOP_10 / total, total_score_NDOP_20 / total, total_score_NDOP_30 / total])
                        first_row = ['stock', 'Year', 'Month', 'Date', 'CP_td', 'Big CP',
                                     ...
                                     '5D score', '10D score', '20D score', '30D score', '60D score',
                                     '5D score Next CP', '10D score Next CP', '20D score Next CP', '30D score Next CP',
                                     '5D score Next OP', '10D score Next OP', '20D score Next OP', '30D score Next OP',
                                     len(write_down_list) / total]

                        path = folder + str(name) + '_' + str(last) + '_Y' + str(
                                align_y) + '_T' + str(align_t) + '_' + str(slope)
                        i = 0
                        while os.path.isfile(path + '_↗_' + str(i) + '.csv'):
                            i = i + 1
                        with open(path + '_↗_' + str(i) + '.csv', 'w', newline='') as csvfile:
                        ...
                        i = 0
                        while os.path.isfile(path + '_All_' + str(i) + '.csv'):
                            i = i + 1
                        with open(path + '_All_' + str(i) + '.csv', 'w', newline='') as csvfile:
                            writer = csv.writer(csvfile)
                            writer.writerow(first_row)
...
i = 0
while os.path.isfile(folder + 'Total_list+_' + str(i) + '.csv'):
    i = i + 1
...
with open(folder + 'Total_list_' + str(i) + '.csv', 'w', newline='') as csvfile:
    ...
    writer.writerow(
        ['name', 'total', 'last', 'align_y', 'align_t', 'slope',
         ...
         '5 score NDCP', '10 score NDCP', '20 score NDCP', '30 score NDCP',
         '5 score NDOP', '10 score NDOP', '20 score NDOP', '30 score NDOP'])
